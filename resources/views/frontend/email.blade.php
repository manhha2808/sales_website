...
<head>
	...
	<title>IT LAPTOP - Hoàn thành</title>
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							<li class="menu-item"><a href="#" title="">Sony VAIO</a></li>
							<li class="menu-item"><a href="#" title="">Lenovo</a></li>
							<li class="menu-item"><a href="#" title="">Dell</a></li>
					...
					<div id="wrap-inner">
						...
						<div id="hoa-don">
							...
							<table class="table-bordered table-responsive">
								...
								<tr>
									<td>{{$item->name}}</td>
									<td class="price">{{numbe_format($item->price)}} VNĐ</td>
									<td>{{$item->qty}}</td>

...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{ asset('admin/home') }}"><span class="text-success">IT Laptop</span> Shop</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{ asset('admin/category') }}"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg>Danh mục</a></li>
			<li><a href="{{ asset('admin/product') }}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg>Sản phẩm</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
